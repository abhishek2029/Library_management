...
def View(): 
    ...
    headingLabel = Label(headingFrame1, text="View Books", bg='black', fg='white', font=('Arial',15))
    ...
    Label(labelFrame, text="%-10s%-40s%-30s%-30s"%('BID','Title','Author','Status'),bg='black',fg='white').place(relx=0.07,rely=0.1)
